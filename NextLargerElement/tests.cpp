...
TEST(NextLargerElementTest1, BasicAssertions) {
...
TEST(NextLargerElementTest2, BasicAssertions) {
...
TEST(NextLargerElementTest3, BasicAssertions) {
...
TEST(NextLargerElementTest4, BasicAssertions) {
